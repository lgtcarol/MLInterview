...
### 读取数据
print("载入数据")
dataset1 = pd.read_csv('train_data1.csv')
dataset2 = pd.read_csv('train_data2.csv')
dataset3 = pd.read_csv('train_data3.csv')
dataset4 = pd.read_csv('train_data4.csv')
dataset5 = pd.read_csv('train_data5.csv')
